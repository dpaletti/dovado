...
_tau_maxs = { "nc": tau_max_nc,"c": tau_max_c,"ct": tau_max_ct,"ctt": tau_max_ctt }
_tau_mins = { "nc": tau_min_nc,"c": tau_min_c,"ct": tau_min_ct,"ctt": tau_min_ctt }
_tau_stars = { "nc": tau_star_nc,"c": tau_star_c,"ct": tau_star_ct,"ctt": tau_star_ctt }
...
_tau_smallps = { "nc": tau_nc_smallp,"c": tau_c_smallp,"ct": tau_ct_smallp,"ctt": tau_ctt_smallp }
...
_tau_largeps = { "nc": tau_nc_largep,"c": tau_c_largep,"ct": tau_ct_largep,"ctt": tau_ctt_largep }
z_star_nc = [- 2.9, - 8.7, - 14.8, - 20.9, - 25.7, - 30.5]
z_star_c = [- 8.9, - 14.3, - 19.5, - 25.1, - 29.6, - 34.4]
z_star_ct = [- 15, - 19.6, - 25.3, - 29.6, - 31.8, - 38.4]
...
def mackinnonp(teststat, regression=..., N=..., lags=...):
    """
...
tau_2010s = { "nc": tau_nc_2010,"c": tau_c_2010,"ct": tau_ct_2010,"ctt": tau_ctt_2010 }
def mackinnoncrit(N=..., regression=..., nobs=...):
    """
