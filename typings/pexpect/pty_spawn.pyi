...
class spawn(SpawnBase):
    ...
    use_native_pty_fork = ...
    def __init__(self, command, args=..., timeout=..., maxread=..., searchwindowsize=..., logfile=..., cwd=..., env=..., ignore_sighup=..., echo=..., preexec_fn=..., encoding=..., codec_errors=..., dimensions=..., use_poll=...) -> None:
    ...
    def interact(self, escape_character=..., input_filter=..., output_filter=...):
