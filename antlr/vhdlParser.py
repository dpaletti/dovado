...
class vhdlParser ( Parser ):
    ...
    def break_statement(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==vhdlParser.FOR or ((((_la - 118)) & ~0x3f) == 0 and ((1 << (_la - 118)) & ((1 << (vhdlParser.BASIC_IDENTIFIER - 118)) | (1 << (vhdlParser.EXTENDED_IDENTIFIER - 118)) | (1 << (vhdlParser.STRING_LITERAL - 118)))) != 0):
                self.state = 840
                self.break_list()
    ...
    def concurrent_signal_assignment_statement(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [vhdlParser.BASIC_IDENTIFIER, vhdlParser.EXTENDED_IDENTIFIER, vhdlParser.STRING_LITERAL, vhdlParser.LPAREN]:
                self.state = 980
    ...
    def group_constituent(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [vhdlParser.BASIC_IDENTIFIER, vhdlParser.EXTENDED_IDENTIFIER, vhdlParser.STRING_LITERAL]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1381
                self.name()
                pass
    ...
    def instantiated_unit(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [vhdlParser.COMPONENT, vhdlParser.BASIC_IDENTIFIER, vhdlParser.EXTENDED_IDENTIFIER, vhdlParser.STRING_LITERAL]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1471
                self._errHandler.sync(self)
                _la = self._input.LA(1)
    ...
    def procedural_statement_part(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << vhdlParser.ASSERT) | (1 << vhdlParser.BREAK) | (1 << vhdlParser.CASE) | (1 << vhdlParser.EXIT) | (1 << vhdlParser.FOR) | (1 << vhdlParser.IF) | (1 << vhdlParser.LOOP) | (1 << vhdlParser.NEXT) | (1 << vhdlParser.NULL))) != 0) or ((((_la - 79)) & ~0x3f) == 0 and ((1 << (_la - 79)) & ((1 << (vhdlParser.REPORT - 79)) | (1 << (vhdlParser.RETURN - 79)) | (1 << (vhdlParser.WAIT - 79)) | (1 << (vhdlParser.WHILE - 79)) | (1 << (vhdlParser.BASIC_IDENTIFIER - 79)) | (1 << (vhdlParser.EXTENDED_IDENTIFIER - 79)) | (1 << (vhdlParser.STRING_LITERAL - 79)) | (1 << (vhdlParser.LPAREN - 79)))) != 0):
                self.state = 1900
