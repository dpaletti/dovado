...
class CMAES(LocalSearch):
    def __init__(self, x0=..., sigma=..., parallelize=..., maxfevals=..., tolfun=..., tolx=..., restarts=..., restart_from_best=..., incpopsize=..., eval_initial_x=..., noise_handler=..., noise_change_sigma_exponent=..., noise_kappa_exponent=..., bipop=..., cmaes_verbose=..., verb_log=..., display=..., **kwargs) -> None:
        """
    ...
    def setup(self, problem, seed=..., **kwargs):
        ...
