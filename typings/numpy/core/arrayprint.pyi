...
@set_module('numpy')
def set_printoptions(precision=..., threshold=..., edgeitems=..., linewidth=..., suppress=..., nanstr=..., infstr=..., formatter=..., sign=..., floatmode=..., *, legacy=...):
    """
...
def array2string(a, max_line_width=..., precision=..., suppress_small=..., separator=..., prefix=..., style=..., formatter=..., threshold=..., edgeitems=..., sign=..., floatmode=..., suffix=..., *, legacy=...):
    """
