...
def run(command, timeout=..., withexitstatus=..., events=..., extra_args=..., logfile=..., cwd=..., env=..., **kwargs):
    '''
...
def runu(command, timeout=..., withexitstatus=..., events=..., extra_args=..., logfile=..., cwd=..., env=..., **kwargs):
