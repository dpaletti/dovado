...
class vhdlVisitor(ParseTreeVisitor):
    ...
    def visitAccess_type_definition(
    ...
    def visitBreak_selector_clause(
    ...
    def visitCase_statement_alternative(
    ...
    def visitComponent_instantiation_statement(
    ...
    def visitComposite_type_definition(
    ...
    def visitConcurrent_assertion_statement(
    ...
    def visitConcurrent_break_statement(
    ...
    def visitConcurrent_procedure_call_statement(
    ...
    def visitConcurrent_signal_assignment_statement(
    ...
    def visitConfiguration_declarative_item(
    ...
    def visitConstrained_array_definition(
    ...
    def visitConstrained_nature_definition(
    ...
    def visitDisconnection_specification(
    ...
    def visitElement_subtype_definition(
    ...
    def visitEntity_statement_part(
    ...
    def visitGroup_constituent_list(
    ...
    def visitGroup_template_declaration(
    ...
    def visitGuarded_signal_specification(
    ...
    def visitInterface_quantity_declaration(
    ...
    def visitInterface_terminal_declaration(
    ...
    def visitInterface_variable_declaration(
    ...
    def visitNature_element_declaration(
    ...
    def visitPackage_body_declarative_item(
    ...
    def visitPackage_body_declarative_part(
    ...
    def visitPhysical_type_definition(
    ...
    def visitProcedural_declarative_item(
    ...
    def visitProcedural_declarative_part(
    ...
    def visitProcedural_statement_part(
    ...
    def visitQuantity_specification(
    ...
    def visitSecondary_unit_declaration(
    ...
    def visitSimple_simultaneous_statement(
    ...
    def visitSimultaneous_if_statement(
    ...
    def visitSimultaneous_procedural_statement(
    ...
    def visitSubprogram_declarative_part(
    ...
    def visitUnconstrained_array_definition(
    ...
    def visitUnconstrained_nature_definition(
    ...
    def visitVariable_assignment_statement(
