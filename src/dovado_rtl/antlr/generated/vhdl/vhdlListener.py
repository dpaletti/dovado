...
class vhdlListener(antlr.ParseTreeListener):
    ...
    def enterArchitecture_declarative_part(
        self, ctx: vhdlParser.Architecture_declarative_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#architecture_declarative_part.
    def exitArchitecture_declarative_part(
        self, ctx: vhdlParser.Architecture_declarative_partContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#architecture_statement.
    def enterArchitecture_statement(
        self, ctx: vhdlParser.Architecture_statementContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#architecture_statement.
    def exitArchitecture_statement(
        self, ctx: vhdlParser.Architecture_statementContext
    ):
        pass
    ...
    def enterArray_nature_definition(
        self, ctx: vhdlParser.Array_nature_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#array_nature_definition.
    def exitArray_nature_definition(
        self, ctx: vhdlParser.Array_nature_definitionContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#array_type_definition.
    def enterArray_type_definition(
        self, ctx: vhdlParser.Array_type_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#array_type_definition.
    def exitArray_type_definition(
        self, ctx: vhdlParser.Array_type_definitionContext
    ):
        pass
    ...
    def exitBlock_declarative_item(
        self, ctx: vhdlParser.Block_declarative_itemContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#block_declarative_part.
    def enterBlock_declarative_part(
        self, ctx: vhdlParser.Block_declarative_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#block_declarative_part.
    def exitBlock_declarative_part(
        self, ctx: vhdlParser.Block_declarative_partContext
    ):
        pass
    ...
    def enterBlock_specification(
        self, ctx: vhdlParser.Block_specificationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#block_specification.
    def exitBlock_specification(
        self, ctx: vhdlParser.Block_specificationContext
    ):
        pass
    ...
    def enterBlock_statement_part(
        self, ctx: vhdlParser.Block_statement_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#block_statement_part.
    def exitBlock_statement_part(
        self, ctx: vhdlParser.Block_statement_partContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#branch_quantity_declaration.
    def enterBranch_quantity_declaration(
        self, ctx: vhdlParser.Branch_quantity_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#branch_quantity_declaration.
    def exitBranch_quantity_declaration(
        self, ctx: vhdlParser.Branch_quantity_declarationContext
    ):
        pass
    ...
    def enterBreak_selector_clause(
        self, ctx: vhdlParser.Break_selector_clauseContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#break_selector_clause.
    def exitBreak_selector_clause(
        self, ctx: vhdlParser.Break_selector_clauseContext
    ):
        pass
    ...
    def enterCase_statement_alternative(
        self, ctx: vhdlParser.Case_statement_alternativeContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#case_statement_alternative.
    def exitCase_statement_alternative(
        self, ctx: vhdlParser.Case_statement_alternativeContext
    ):
        pass
    ...
    def enterConditional_signal_assignment(
        self, ctx: vhdlParser.Conditional_signal_assignmentContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#conditional_signal_assignment.
    def exitConditional_signal_assignment(
        self, ctx: vhdlParser.Conditional_signal_assignmentContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#conditional_waveforms.
    def enterConditional_waveforms(
        self, ctx: vhdlParser.Conditional_waveformsContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#conditional_waveforms.
    def exitConditional_waveforms(
        self, ctx: vhdlParser.Conditional_waveformsContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#configuration_declaration.
    def enterConfiguration_declaration(
        self, ctx: vhdlParser.Configuration_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#configuration_declaration.
    def exitConfiguration_declaration(
        self, ctx: vhdlParser.Configuration_declarationContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#configuration_declarative_item.
    def enterConfiguration_declarative_item(
        self, ctx: vhdlParser.Configuration_declarative_itemContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#configuration_declarative_item.
    def exitConfiguration_declarative_item(
        self, ctx: vhdlParser.Configuration_declarative_itemContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#configuration_declarative_part.
    def enterConfiguration_declarative_part(
        self, ctx: vhdlParser.Configuration_declarative_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#configuration_declarative_part.
    def exitConfiguration_declarative_part(
        self, ctx: vhdlParser.Configuration_declarative_partContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#configuration_item.
    def enterConfiguration_item(
        self, ctx: vhdlParser.Configuration_itemContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#configuration_item.
    def exitConfiguration_item(
        self, ctx: vhdlParser.Configuration_itemContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#configuration_specification.
    def enterConfiguration_specification(
        self, ctx: vhdlParser.Configuration_specificationContext
    ):
        pass
    ...
    def enterConstant_declaration(
        self, ctx: vhdlParser.Constant_declarationContext
    ):
        pass
    ...
    def enterConstrained_array_definition(
        self, ctx: vhdlParser.Constrained_array_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#constrained_array_definition.
    def exitConstrained_array_definition(
        self, ctx: vhdlParser.Constrained_array_definitionContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#constrained_nature_definition.
    def enterConstrained_nature_definition(
        self, ctx: vhdlParser.Constrained_nature_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#constrained_nature_definition.
    def exitConstrained_nature_definition(
        self, ctx: vhdlParser.Constrained_nature_definitionContext
    ):
        pass
    ...
    def enterDisconnection_specification(
        self, ctx: vhdlParser.Disconnection_specificationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#disconnection_specification.
    def exitDisconnection_specification(
        self, ctx: vhdlParser.Disconnection_specificationContext
    ):
        pass
    ...
    def enterEntity_specification(
        self, ctx: vhdlParser.Entity_specificationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#entity_specification.
    def exitEntity_specification(
        self, ctx: vhdlParser.Entity_specificationContext
    ):
        pass
    ...
    def enterEntity_statement_part(
        self, ctx: vhdlParser.Entity_statement_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#entity_statement_part.
    def exitEntity_statement_part(
        self, ctx: vhdlParser.Entity_statement_partContext
    ):
        pass
    ...
    def enterEnumeration_literal(
        self, ctx: vhdlParser.Enumeration_literalContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#enumeration_literal.
    def exitEnumeration_literal(
        self, ctx: vhdlParser.Enumeration_literalContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#enumeration_type_definition.
    def enterEnumeration_type_definition(
        self, ctx: vhdlParser.Enumeration_type_definitionContext
    ):
        pass
    ...
    def enterFile_open_information(
        self, ctx: vhdlParser.File_open_informationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#file_open_information.
    def exitFile_open_information(
        self, ctx: vhdlParser.File_open_informationContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#file_type_definition.
    def enterFile_type_definition(
        self, ctx: vhdlParser.File_type_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#file_type_definition.
    def exitFile_type_definition(
        self, ctx: vhdlParser.File_type_definitionContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#formal_parameter_list.
    def enterFormal_parameter_list(
        self, ctx: vhdlParser.Formal_parameter_listContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#formal_parameter_list.
    def exitFormal_parameter_list(
        self, ctx: vhdlParser.Formal_parameter_listContext
    ):
        pass
    ...
    def enterGeneric_map_aspect(
        self, ctx: vhdlParser.Generic_map_aspectContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#generic_map_aspect.
    def exitGeneric_map_aspect(
        self, ctx: vhdlParser.Generic_map_aspectContext
    ):
        pass
    ...
    def enterGroup_constituent_list(
        self, ctx: vhdlParser.Group_constituent_listContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#group_constituent_list.
    def exitGroup_constituent_list(
        self, ctx: vhdlParser.Group_constituent_listContext
    ):
        pass
    ...
    def enterGroup_template_declaration(
        self, ctx: vhdlParser.Group_template_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#group_template_declaration.
    def exitGroup_template_declaration(
        self, ctx: vhdlParser.Group_template_declarationContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#guarded_signal_specification.
    def enterGuarded_signal_specification(
        self, ctx: vhdlParser.Guarded_signal_specificationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#guarded_signal_specification.
    def exitGuarded_signal_specification(
        self, ctx: vhdlParser.Guarded_signal_specificationContext
    ):
        pass
    ...
    def enterInstantiation_list(
        self, ctx: vhdlParser.Instantiation_listContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#instantiation_list.
    def exitInstantiation_list(
        self, ctx: vhdlParser.Instantiation_listContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#interface_constant_declaration.
    def enterInterface_constant_declaration(
    ...
    def exitInterface_constant_declaration(
        self, ctx: vhdlParser.Interface_constant_declarationContext
    ):
        pass
    ...
    def enterInterface_quantity_declaration(
        self, ctx: vhdlParser.Interface_quantity_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#interface_quantity_declaration.
    def exitInterface_quantity_declaration(
        self, ctx: vhdlParser.Interface_quantity_declarationContext
    ):
        pass
    ...
    def enterInterface_signal_declaration(
    ...
    def exitInterface_signal_declaration(
        self, ctx: vhdlParser.Interface_signal_declarationContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#interface_terminal_declaration.
    def enterInterface_terminal_declaration(
        self, ctx: vhdlParser.Interface_terminal_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#interface_terminal_declaration.
    def exitInterface_terminal_declaration(
        self, ctx: vhdlParser.Interface_terminal_declarationContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#interface_variable_declaration.
    def enterInterface_variable_declaration(
        self, ctx: vhdlParser.Interface_variable_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#interface_variable_declaration.
    def exitInterface_variable_declaration(
        self, ctx: vhdlParser.Interface_variable_declarationContext
    ):
        pass
    ...
    def enterMultiplying_operator(
        self, ctx: vhdlParser.Multiplying_operatorContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#multiplying_operator.
    def exitMultiplying_operator(
        self, ctx: vhdlParser.Multiplying_operatorContext
    ):
        pass
    ...
    def enterNature_element_declaration(
        self, ctx: vhdlParser.Nature_element_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#nature_element_declaration.
    def exitNature_element_declaration(
        self, ctx: vhdlParser.Nature_element_declarationContext
    ):
        pass
    ...
    def enterObject_declaration(
        self, ctx: vhdlParser.Object_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#object_declaration.
    def exitObject_declaration(
        self, ctx: vhdlParser.Object_declarationContext
    ):
        pass
    ...
    def enterPackage_body_declarative_item(
    ...
    def exitPackage_body_declarative_item(
        self, ctx: vhdlParser.Package_body_declarative_itemContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#package_body_declarative_part.
    def enterPackage_body_declarative_part(
        self, ctx: vhdlParser.Package_body_declarative_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#package_body_declarative_part.
    def exitPackage_body_declarative_part(
        self, ctx: vhdlParser.Package_body_declarative_partContext
    ):
        pass
    ...
    def enterPhysical_type_definition(
        self, ctx: vhdlParser.Physical_type_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#physical_type_definition.
    def exitPhysical_type_definition(
        self, ctx: vhdlParser.Physical_type_definitionContext
    ):
        pass
    ...
    def enterProcedural_declarative_item(
        self, ctx: vhdlParser.Procedural_declarative_itemContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#procedural_declarative_item.
    def exitProcedural_declarative_item(
        self, ctx: vhdlParser.Procedural_declarative_itemContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#procedural_declarative_part.
    def enterProcedural_declarative_part(
        self, ctx: vhdlParser.Procedural_declarative_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#procedural_declarative_part.
    def exitProcedural_declarative_part(
        self, ctx: vhdlParser.Procedural_declarative_partContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#procedural_statement_part.
    def enterProcedural_statement_part(
        self, ctx: vhdlParser.Procedural_statement_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#procedural_statement_part.
    def exitProcedural_statement_part(
        self, ctx: vhdlParser.Procedural_statement_partContext
    ):
        pass
    ...
    def enterProcedure_call_statement(
        self, ctx: vhdlParser.Procedure_call_statementContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#procedure_call_statement.
    def exitProcedure_call_statement(
        self, ctx: vhdlParser.Procedure_call_statementContext
    ):
        pass
    ...
    def enterProcess_declarative_part(
        self, ctx: vhdlParser.Process_declarative_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#process_declarative_part.
    def exitProcess_declarative_part(
        self, ctx: vhdlParser.Process_declarative_partContext
    ):
        pass
    ...
    def enterProcess_statement_part(
        self, ctx: vhdlParser.Process_statement_partContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#process_statement_part.
    def exitProcess_statement_part(
        self, ctx: vhdlParser.Process_statement_partContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#qualified_expression.
    def enterQualified_expression(
        self, ctx: vhdlParser.Qualified_expressionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#qualified_expression.
    def exitQualified_expression(
        self, ctx: vhdlParser.Qualified_expressionContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#quantity_declaration.
    def enterQuantity_declaration(
        self, ctx: vhdlParser.Quantity_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#quantity_declaration.
    def exitQuantity_declaration(
        self, ctx: vhdlParser.Quantity_declarationContext
    ):
        pass
    ...
    def enterQuantity_specification(
        self, ctx: vhdlParser.Quantity_specificationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#quantity_specification.
    def exitQuantity_specification(
        self, ctx: vhdlParser.Quantity_specificationContext
    ):
        pass
    ...
    def enterRecord_nature_definition(
        self, ctx: vhdlParser.Record_nature_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#record_nature_definition.
    def exitRecord_nature_definition(
        self, ctx: vhdlParser.Record_nature_definitionContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#record_type_definition.
    def enterRecord_type_definition(
        self, ctx: vhdlParser.Record_type_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#record_type_definition.
    def exitRecord_type_definition(
        self, ctx: vhdlParser.Record_type_definitionContext
    ):
        pass
    ...
    def enterRelational_operator(
        self, ctx: vhdlParser.Relational_operatorContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#relational_operator.
    def exitRelational_operator(
        self, ctx: vhdlParser.Relational_operatorContext
    ):
        pass
    ...
    def enterScalar_nature_definition(
        self, ctx: vhdlParser.Scalar_nature_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#scalar_nature_definition.
    def exitScalar_nature_definition(
        self, ctx: vhdlParser.Scalar_nature_definitionContext
    ):
        pass
    ...
    def enterScalar_type_definition(
        self, ctx: vhdlParser.Scalar_type_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#scalar_type_definition.
    def exitScalar_type_definition(
        self, ctx: vhdlParser.Scalar_type_definitionContext
    ):
        pass
    ...
    def enterSequence_of_statements(
        self, ctx: vhdlParser.Sequence_of_statementsContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#sequence_of_statements.
    def exitSequence_of_statements(
        self, ctx: vhdlParser.Sequence_of_statementsContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#sequential_statement.
    def enterSequential_statement(
        self, ctx: vhdlParser.Sequential_statementContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#sequential_statement.
    def exitSequential_statement(
        self, ctx: vhdlParser.Sequential_statementContext
    ):
        pass
    ...
    def enterSignal_declaration(
        self, ctx: vhdlParser.Signal_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#signal_declaration.
    def exitSignal_declaration(
        self, ctx: vhdlParser.Signal_declarationContext
    ):
        pass
    ...
    def enterSource_quantity_declaration(
    ...
    def enterSubprogram_declaration(
        self, ctx: vhdlParser.Subprogram_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#subprogram_declaration.
    def exitSubprogram_declaration(
        self, ctx: vhdlParser.Subprogram_declarationContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#subprogram_declarative_item.
    def enterSubprogram_declarative_item(
        self, ctx: vhdlParser.Subprogram_declarative_itemContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#subprogram_declarative_item.
    def exitSubprogram_declarative_item(
        self, ctx: vhdlParser.Subprogram_declarative_itemContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#subprogram_declarative_part.
    def enterSubprogram_declarative_part(
    ...
    def exitSubprogram_declarative_part(
        self, ctx: vhdlParser.Subprogram_declarative_partContext
    ):
        pass
    ...
    def enterTerminal_declaration(
        self, ctx: vhdlParser.Terminal_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#terminal_declaration.
    def exitTerminal_declaration(
        self, ctx: vhdlParser.Terminal_declarationContext
    ):
        pass
    ...
    def enterUnconstrained_array_definition(
        self, ctx: vhdlParser.Unconstrained_array_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#unconstrained_array_definition.
    def exitUnconstrained_array_definition(
        self, ctx: vhdlParser.Unconstrained_array_definitionContext
    ):
        pass

    # Enter a parse tree produced by vhdlParser#unconstrained_nature_definition.
    def enterUnconstrained_nature_definition(
        self, ctx: vhdlParser.Unconstrained_nature_definitionContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#unconstrained_nature_definition.
    def exitUnconstrained_nature_definition(
        self, ctx: vhdlParser.Unconstrained_nature_definitionContext
    ):
        pass
    ...
    def enterVariable_declaration(
        self, ctx: vhdlParser.Variable_declarationContext
    ):
        pass

    # Exit a parse tree produced by vhdlParser#variable_declaration.
    def exitVariable_declaration(
        self, ctx: vhdlParser.Variable_declarationContext
    ):
        pass
