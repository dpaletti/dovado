...
def get_fieldstructure(adtype, lastname=..., parents=...):
    """
...
def merge_arrays(seqarrays, fill_value=..., flatten=..., usemask=..., asrecarray=...):
    """
...
def drop_fields(base, drop_names, usemask=..., asrecarray=...):
    """
...
def append_fields(base, names, data, dtypes=..., fill_value=..., usemask=..., asrecarray=...):
    """
...
def rec_append_fields(base, names, data, dtypes=...):
    """
    Add new fields to an existing array.
...
def repack_fields(a, align=..., recurse=...):
    """
...
def assign_fields_by_name(dst, src, zero_unassigned=...):
    """
...
def stack_arrays(arrays, defaults=..., usemask=..., asrecarray=..., autoconvert=...):
    """
...
def find_duplicates(a, key=..., ignoremask=..., return_index=...):
    """
...
def join_by(key, r1, r2, jointype=..., r1postfix=..., r2postfix=..., defaults=..., usemask=..., asrecarray=...):
    """
...
def rec_join(key, r1, r2, jointype=..., r1postfix=..., r2postfix=..., defaults=...):
    """
