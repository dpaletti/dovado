...
class config(old_config):
    ...
    def check_type_size(self, type_name, headers=..., include_dirs=..., library_dirs=..., expected=...):
        """Check size of a given type."""
        ...
    
    def check_func(self, func, headers=..., include_dirs=..., libraries=..., library_dirs=..., decl=..., call=..., call_args=...):
        ...
    
    def check_funcs_once(self, funcs, headers=..., include_dirs=..., libraries=..., library_dirs=..., decl=..., call=..., call_args=...):
    ...
    def get_output(self, body, headers=..., include_dirs=..., libraries=..., library_dirs=..., lang=..., use_tee=...):
