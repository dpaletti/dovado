...
class vhdlListener(ParseTreeListener):
    ...
    def enterSelected_name_part(self, ctx:vhdlParser.Selected_name_partContext):
        pass

    # Exit a parse tree produced by vhdlParser#selected_name_part.
    def exitSelected_name_part(self, ctx:vhdlParser.Selected_name_partContext):
        pass


    # Enter a parse tree produced by vhdlParser#function_call_or_indexed_name_part.
    def enterFunction_call_or_indexed_name_part(self, ctx:vhdlParser.Function_call_or_indexed_name_partContext):
        pass

    # Exit a parse tree produced by vhdlParser#function_call_or_indexed_name_part.
    def exitFunction_call_or_indexed_name_part(self, ctx:vhdlParser.Function_call_or_indexed_name_partContext):
        pass
    ...
    def enterAttribute_name_part(self, ctx:vhdlParser.Attribute_name_partContext):
        pass

    # Exit a parse tree produced by vhdlParser#attribute_name_part.
    def exitAttribute_name_part(self, ctx:vhdlParser.Attribute_name_partContext):
        pass
