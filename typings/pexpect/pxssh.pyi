...
class pxssh(spawn):
    ...
    '''
    def __init__(self, timeout=..., maxread=..., searchwindowsize=..., logfile=..., cwd=..., env=..., ignore_sighup=..., echo=..., options=..., encoding=..., codec_errors=..., debug_command_string=..., use_poll=...) -> None:
        ...
    ...
    def sync_original_prompt(self, sync_multiplier=...):
    ...
    def login(self, server, username=..., password=..., terminal_type=..., original_prompt=..., login_timeout=..., port=..., auto_prompt_reset=..., ssh_key=..., quiet=..., sync_multiplier=..., check_local_ip=..., password_regex=..., ssh_tunnels=..., spawn_local_ssh=..., sync_original_prompt=..., ssh_config=..., cmd=...):
